...
public class scamCaseList {
    ...
    public scamCaseList(Date date, double amount, String victim_city, int victim_age, Date post_date, int scam_id, String post_user, String user_name, String user_avatar, String description, String paymentMethod, String title, String scam_type, String contactMethod) {
        this.date = date;
        this.amount = amount;
